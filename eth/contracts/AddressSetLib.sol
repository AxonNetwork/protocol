...
library AddressSetLib {
    ...
    function get(AddressSet storage self, uint index) public view
        inBounds(self, index)
        returns (address)
    {
    ...
    function first(AddressSet storage self) public view
        notEmpty(self)
        returns (address)
    {
        return get(self, 0);
    ...
    function last(AddressSet storage self) public view
        notEmpty(self)
        returns (address)
    {
    ...
    function indexOf(AddressSet storage self, address value) public view
        returns (uint)
    {
        if (!self.exists[value])
            return uint(-1);
    ...
    function contains(AddressSet storage self, address value) public view
        returns (bool)
    {
        return self.exists[value];
    }

    function size(AddressSet storage self) public view
        returns (uint)
    {
